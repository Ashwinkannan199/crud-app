...
app.config['SQLALCHEMY_DATABASE_URI'] = f'postgresql://postgres:Ashwin%401999@localhost/roster_db'
...
def initialize_database():
    ...
    with app.app_context():
        ...
        if not Student.query.filter_by(email='charles@example.com').first():
            print("Adding a new student...")
            new_student = Student(first_name='Charles', email='charles@example.com')
            ...
            db.session.commit()
            print("New student 'Charles' added.")
        else:
